...
public class ManufacturerController {
  ...
  public ResponseEntity<?> getManufacturersWithProductsList() {
    List<ManuWithProdDTO> manusWithProductsCount =
        manufacturerService.getManufacturersWithProducts();
  ...
  public ResponseEntity<?> getManufacturersWithProductsCount(
    ...
    List<CountManuProdDTO> manusWithProductsCount =
        manufacturerService.countManufacturersProducts();
    return ResponseEntity.status(HttpStatus.OK).body(manusWithProductsCount);
  }
}
