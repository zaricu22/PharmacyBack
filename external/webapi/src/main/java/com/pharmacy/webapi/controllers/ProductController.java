...
public class ProductController {
    ...
    public ResponseEntity<ProductDTO> insertProduct(@RequestBody @Validated CreateProductDTO productDTO) {
    ...
    public ResponseEntity<?> updateProduct(
            @PathVariable("id") UUID uuid, @RequestBody @Validated UpdateProductDTO productDTO) {
